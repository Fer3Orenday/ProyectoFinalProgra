...
<body>
    ...
    <div class="card-group">
        <div class="card">
            <img src="../imgsAcercaDe/tenis1.PNG" class="card-img-top imagen2" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="../imgsAcercaDe/tenis2.PNG" class="card-img-top imagen2" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="../imgsAcercaDe/tenis3.PNG" class="card-img-top imagen2" alt="...">
            <div class="card-body">
